...
type Store interface {
	...
	ListArticle(req article.ListArticle)([]article.ListArticleResponse,int64,error)
...
func ListArticle(store Store,req article.ListArticle)([]article.ListArticleResponse,int64,error){
